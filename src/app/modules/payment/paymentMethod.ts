...
export const initiatePayment = async (paymentData: any) => {
  try {
    const response = await axios.post(config.payment_api_url!, {
      ...
      success_url: `https://sport-facility-platform-backend.vercel.app/api/conformation?transactionId=${paymentData.transactionId}&status=Success`,
      fail_url: `https://sport-facility-platform-backend.vercel.app/api/conformation?status=failed`,
